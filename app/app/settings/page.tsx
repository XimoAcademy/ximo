...
const T = {
  es: {
    ...
    pushGranted: "Permitidas · el navegador puede enviarte alertas push en tiempo real.",
    pushDenied: "Bloqueadas · actívalas desde Configuración del navegador → Privacidad → Notificaciones.",
    pushDefault: "¿Nos permites enviarte notificaciones en tiempo real desde el navegador?",
    ...
    communityNotifDesc: "Respuestas a tus publicaciones y menciones.",
    accountTitle: "Cuenta",
    nameLabel: "Nombre",
    emailLabel: "Email",
    planLabel: "Plan",
  ...
  en: {
    ...
    pushGranted: "Enabled · your browser can send real-time push alerts.",
    pushDenied: "Blocked · enable them from Browser Settings → Privacy → Notifications.",
    pushDefault: "Allow us to send you real-time browser notifications?",
