 ...
 */
export default function CheckoutConfirming({ demo = false }: { demo?: boolean }) {
  ...
  return (
    <div className="relative z-10 mx-auto max-w-md text-center">
      ...
      <h1 className="text-2xl font-black" style={{ color: "var(--text)" }}>
        {demo ? "Estamos activando tu acceso demo" : "Estamos confirmando tu pago"}
      </h1>
      <p className="mx-auto mt-3 max-w-sm text-sm leading-relaxed" style={{ color: "var(--text-2)" }}>
        {demo
          ? "Tu registro de prueba a $0.00 se está confirmando — no se realizó ningún cargo. Esto toma unos segundos y te llevaremos a tu panel automáticamente."
          : "Gracias por suscribirte a Ximo. Esto suele tomar unos segundos. Te llevaremos a tu panel automáticamente."}
      </p>
      {slow && (
        <p className="mx-auto mt-5 max-w-sm text-xs leading-relaxed" style={{ color: "var(--text-label)" }}>
          {demo
            ? "Está tardando un poco más de lo normal. Tu acceso demo se activará en breve."
